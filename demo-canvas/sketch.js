...
(function () {
  ...
  function drawAddons() {
    ...
    if (gui.beginTabItem('Data')) {
      gui.addons.plots.plotBars('bars — hover a bar (negatives hang below zero)', barData, { share: 2 });
    ...
    if (gui.beginTabItem('Table')) {
      gui.addons.tables.advancedTable('nodes — click headers to sort, click rows to select',
        [
