...
(function (root, factory) {
  ...
  function () {
    ...
    class CanvasRenderer {
      ...
      endFrame() {
        /* context state is re-established every draw call */
      }
      setLayer(l) {
        this._layer = l;
      }
    ...
    class CanvasInput {
      constructor(canvas, opts) {
        ...
        this.canvas = canvas;
        this.win =
          opts.win || (typeof window !== "undefined" ? window : globalThis);
        ...
        on(this.win, this._listeners.win, "mousemove", (e) => {
          this._pos(e);
        });
